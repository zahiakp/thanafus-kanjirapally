...
function Reporting() {
    ...
    const fetchPrograms = useCallback(async () => {
        ...
        try {
          let response;
            response = await getProgramsbyStatusandPagination("reporting,ongoing", params.toString(), proEndpoint);
    ...
    const renderContent = () => {
        ...
        return (
          <>
          <p className="text-xl  mb-5 font-semibold">Pending & Ongoing Programs</p>
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                          <div className="flex gap-2 z-10">
                            ...
                            program.participantsData.some(
                              ...
                              <p className="text-red-600">No Code</p>
                            )}
                          </div>
                        </td>
                      </tr>
              ...
              {report && (
                <Report close={setReport} data={report} fetch={fetchPrograms} />
              )}
            </div>
          </>
        );
