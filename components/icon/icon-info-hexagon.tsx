...
const IconInfoHexagon: FC<IconInfoHexagonProps> = ({ className ,size}) => {
    return (
        <svg width={size?size:"20"} height={size?size:"20"} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
